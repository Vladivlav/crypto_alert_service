# spec/domains/binance/services/sync_pairs_spec.rb
require 'rails_helper'
require 'dry/monads'

module Binance
  RSpec.describe Services::SyncPairs, type: :service do
    include Dry::Monads[:result]

    let(:request_service) { instance_double(Requests::GetCryptoPairs) }
