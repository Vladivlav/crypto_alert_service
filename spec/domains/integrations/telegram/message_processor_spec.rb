# spec/domains/integrations/telegram/message_processor_spec.rb

require 'rails_helper'
require 'dry/monads'

module Integrations
  RSpec.describe Telegram::MessageProcessor, type: :service do
    ...
    describe '#call' do
      ...
      context 'when message is a command to stop the bot' do
        ...
        it 'deactivates the notification channel' do
          processor.call(channel: channel, message: message)
          expect(deactivator_service).to have_received(:call).with(channel)
        end
