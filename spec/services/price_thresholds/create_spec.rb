# spec/services/price_thresholds/create_spec.rb

require "rails_helper"
require_relative '../../../app/services/price_thresholds/create'

RSpec.describe PriceThresholds::Create do
  # --- 1. Мокирование зависимостей ---
  let(:model_klass)      { class_double(PriceThreshold) }
  let(:pair_model_klass) { class_double(CryptoPair) }
  let(:redis_synchronizer) { instance_double(PriceThresholds::RedisSynchronizer) }
